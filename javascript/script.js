...
function updateTimer() {
  const targetDate = new Date("October 11, 2026 00:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543813469732'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543813469732'; // Número para el primer botón
  const recipientNumber2 = '543815995167'; // Número para el segundo botón
